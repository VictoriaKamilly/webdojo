describe('Links abrindo nova guia/janela', () => {
    it('Validando o atributo do link do Instagram', () => {
        ...
        cy.get('[data-cy="instagram-link"]')
            .should('have.attr', 'href', 'https://www.instagram.com/qapapito') // valida se esta indo para o caminho correto quando o sistema não é da empresa
            .and('have.attr', 'target', '_blank')
    });

    it('Acessa link de termos de uso removendo o target blank', () => { //cenario para contornar o target
        cy.start()
        cy.submitLoginForm("papito@webdojo.com", "katana123")
